/*! For license information please see cctvh5-openapicore.min.js.LICENSE.txt */
!function(e, t) {
    ...
    return function() {
        var e = {
            ...
            963: function(e, t, r) {
                "use strict";
                e.exports = r.p + "4ff8b4d813c0c8790dbf.wasm"
            }
        }
          , t = {};
        function r(n) {
        ...
        return function() {
            ...
            var A, P = O, D = r(587), U = r.n(D), M = r(571), F = r.n(M), G = function(e) {
                ...
                var h = window.fetch(n, p).then((function(e) {
                    l = e;
                    var t = r.dataType
                      , n = void 0 === t ? "json" : t
                      , o = !1;
                    ...
                    return function(e) {
                        var t = e.response
                          ...
                          , n = e.conf
                          , o = t ? t.status : 0
                          , a = t ? t.statusText : "null"
                          , c = t ? t.type : "empty"
                          , u = i()(r, "message") || a || "请求失败，请检查网络";
                        o ? u = "[" + o + "]" + u : c && (u = "[" + c + "]" + u);
                        var f = "[request#" + n.name + "]:" + u;
                        return R.error(f),
                        "function" === s()(n.resolveErrorMsg) && n.resolveErrorMsg(u, {
                            type: c,
                            status: o,
                            error: r,
                            code: r.code
            ...
            var V = 0
              , $ = null;
            function z() {
                return null !== $ && 0 !== $.byteLength || ($ = new Uint8Array(A.memory.buffer)),
                $
            }
            ...
            : function(e, t) {
              ...
              , H = null;
            function K() {
                return (null === H || !0 === H.buffer.detached || void 0 === H.buffer.detached && H.buffer !== A.memory.buffer) && (H = new DataView(A.memory.buffer)),
                H
            }
            var Q = W.length;
            ...
            function oe() {
                return (oe = Y(I().mark((function e(t, r) {
                    var n, o;
            ...
            function se(e) {
                if (void 0 !== A)
                    return A;
                void 0 !== e && Object.getPrototypeOf(e) === Object.prototype ? e = e.module : console.warn("using deprecated parameters for `initSync()`; pass a single object instead");
                var t = ie();
            ...
            function ue() {
                return (ue = Y(I().mark((function e(t) {
                    var n, o, i, a;
                    return I().wrap((function(e) {
                        for (; ; )
                            switch (e.prev = e.next) {
                            ...
                            case 2:
                                return void 0 !== t && Object.getPrototypeOf(t) === Object.prototype ? t = t.module_or_path : console.warn("using deprecated parameters for the initialization function; pass a single object instead"),
                                void 0 === t && (t = new URL(r(963),r.b)),
                                n = ie(),
                                ...
                                for (; ; )
                                    ...
                                    case 0:
                                        ...
                                        return i = new Promise((function(e) {
                                            ve(n).then(e).catch((function(e) {
                                                R.warn(pe, e)
                                            }
                                            )),
                                            ge(n).then(e).catch((function(e) {
                                                R.warn(pe, e)
                                            }
                                            ))
                                        }
            ...
            var we = function(e, t, r, n) {
              ...
              , _e = function() {
                function e(e) {
                    ...
                    Object.defineProperty(this, "requireTokenRefresh", {
                        enumerable: !0,
                        configurable: !0,
                        writable: !0,
                        value: !1
                        ...
                        return I().wrap((function(e) {
                            for (; ; )
                                ...
                                case 24:
                                    ...
                                    console.error(e.t0);
                                case 27:
                                    return c && c.token || R.warn("fetch token error"),
                                    e.abrupt("return", c);
                                case 29:
                                case "end":
                                    return e.stop()
                        ...
                        return I().wrap((function(e) {
                            for (; ; )
                                ...
                                case 5:
                                    ...
                                    (null == r ? void 0 : r.token) ? (this.token = r.token,
                                    this.requireTokenRefresh = !1,
                                    o = parseInt("" + r.expire, 10) || 0,
                                    i = Math.max(o, 6e4),
                                    P.isTest() && (i = 6e4),
                                    this.expireTime = n + i,
                                    this.setRefreshTask(i - 3e4)) : this.requireTokenRefresh = !0;
                                case 9:
                                case "end":
                                    return e.stop()
                                }
                        ...
                        return I().wrap((function(e) {
                            for (; ; )
                                ...
                                case 0:
                                    ...
                                    this.token = ""),
                                    this.token && !this.requireTokenRefresh) {
                                        e.next = 10;
                                        break
                                    }
                ...
                ,
                t.setRefreshTask = function(e) {
                    var t = this;
                    this.clearRefreshTask();
                    var r = Math.max(e, 1e4);
            ...
            function Ee(e) {
                return xe(this, void 0, void 0, I().mark((function t() {
                    var r, n, o, i, a, s, c, u, f, l, p, h, d, v;
                    return I().wrap((function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                            case 0:
                            ...
                            case 15:
                                ...
                                d = (new Date).getTime(),
                                v = h + "-" + a,
                                R.debug(Se, "get signature " + v + " cost " + (d - l) + "ms"),
                                u.openapi_signature = v,
                                t.abrupt("return", u);
                            case 21:
                            case "end":
                                return t.stop()
